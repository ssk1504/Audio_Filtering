...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/2_2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/2.2.py
\end{lstlisting}
\newpage
\begin{figure}[htbp]
	\centering
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/4.2.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/6.1.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
