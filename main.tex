...
\title{}
\author{EE23BTECH11054 -  Sai Krishna Shanigarapu \par Audio Filtering
}
\maketitle
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/audio/keyboard.wav
\end{lstlisting}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\columnwidth]{figs/spectrogram_with_noise.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\columnwidth]{figs/spectrogram_reduced_noise.png}
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/3.2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/3.2.py
\end{lstlisting}
\newpage
\begin{figure}[htbp]
	\centering
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/4.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/5.2.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/5.4.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
%
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/5.5.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/6_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/6.4.py  
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/6.5.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/7.1.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/7.1_a_b.py
\end{lstlisting}
generates the values of $a$ and $b$  which can be used to generate a difference equation.\\
And,
\begin{align}
    M &= 5\\
    N&=5
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/7.2.py
\end{lstlisting}
\input{tables/audio_filter_tab}
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{figs/h(n)_6_2.png}
...
\begin{lstlisting}
https://github.com/ssk1504/Audio_Filtering/blob/main/codes/7_filter_response.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
